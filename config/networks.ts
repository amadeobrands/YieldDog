...
// Networks
// -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
import { arbitrum, arbitrumGoerli, baseGoerli, goerli, hardhat, mainnet, optimism, polygon, sepolia } from '@wagmi/core/chains'
...
const CHAINS_SUPPORTED_BY_PUBLIC_PROVIDER = [arbitrum, goerli, mainnet, optimism, polygon, sepolia]
